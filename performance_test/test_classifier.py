...
def anticipate_snore(file_name):
    ...
    # spectogram 1025
    model = make_model(input_shape=(None, 1025))
    # model = make_model(input_shape=(None, 128))
    model.load_weights("my_model/my_model5_weight.hdf5")
...
df.to_pickle('test_result5.csv')
results = pd.read_pickle('test_result5.csv')
